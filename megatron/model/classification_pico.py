...
class Classification_pico(MegatronModule):
    ...
    def __init__(self,
                 ...
                 pre_process=True,
                 post_process=True):
        super(Classification_pico, self).__init__(share_word_embeddings=False)
        args = get_args()
    ...
    def forward(self, model_input, attention_mask, tokentype_ids=None):
        ...
        if self.post_process:
            ...
            x = torch.reshape(x, (x.shape[0], x.shape[1], self.num_classes, 2))
